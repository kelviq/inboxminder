...
- Use the name to refer to this project truthfully ("built on
  InboxMinder", "a fork of InboxMinder").
- Keep the default label names when *running* the software.
...
That's the whole policy: fork freely (the license guarantees it), just
