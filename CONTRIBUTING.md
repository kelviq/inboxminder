...
Thanks for your interest! InboxMinder is a small, focused tool —
...
- First-time contributors will be asked by the CLA bot to accept the
  [CLA](CLA.md) — it's short, disclosed in the README, and exists so the
  project can stay AGPL while Kelviq offers a commercial Pro edition.
